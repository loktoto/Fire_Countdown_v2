...
import { FIRE_COMPANION_IDS, FireCompanionArtwork } from "./FireCompanion";
...
export function FireCompanionPickerSheet({
  visible,
  value,
  onSelect,
  onClose,
  ...
  visible: boolean;
  value: FireCompanionId;
  onSelect: (id: FireCompanionId) => boolean;
  onClose: () => void;
}) {
      ...
      <View style={styles.modalRoot}>
        ...
        >
          ...
          <View style={styles.grid}>
            {FIRE_COMPANION_IDS.map((id) => {
              const selected = id === value;
              const label = t.fireImpact.companionNames[id];
              return (
                <MotionPressable
                  key={id}
                  onPress={() => {
                ...
                >
                  ...
                  >
                    <FireCompanionArtwork id={id} tone={colors.primary} size={58} />
                  </View>
                  <Text
                    numberOfLines={1}
